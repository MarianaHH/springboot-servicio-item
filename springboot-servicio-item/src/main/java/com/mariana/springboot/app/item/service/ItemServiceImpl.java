...
public class ItemServiceImpl implements ItemService {
	...
	public List<Item> findAll() {
		List<Producto> productos = Arrays.asList(clienteRest.getForObject("http://servicio-productos/findAll",Producto[].class));
	...
	public Item findById(Long id, Integer cantidad) {
		...
		Producto producto = clienteRest.getForObject("http://servicio-productos/findProductoById/{id}", Producto.class,pathVariables);
